    ...
    pw.Page(
      build: (pw.Context context) {
        return pw.Center(
          child: pw.Column(
            children: [
              pw.Text('Detalles de la licencia', style: pw.TextStyle(fontSize: 20)),
              pw.Text('Estudiante: ${license.user!.name} ${license.user!.lastname} ${license.user!.surname}', style: pw.TextStyle(fontSize: 14)),
              pw.Text('Curso: ${license.user!.grade}', style: pw.TextStyle(fontSize: 14)),
              pw.Text('Fecha: ${formatDate(license.license_date)}', style: pw.TextStyle(fontSize: 14)),
              pw.Text('De: ${license.departure_time}', style: pw.TextStyle(fontSize: 14)),
              pw.Text('Hasta: ${license.return_time}', style: pw.TextStyle(fontSize: 14)),
              pw.Text('Motivo: ${license.reason}', style: pw.TextStyle(fontSize: 14)),
              if (license.justification != '' && screenshot != null)
                pw.Image(pw.MemoryImage(screenshot)),
              if (license.justification == '')
                pw.Text('El usuario no subió un justificativo', style: pw.TextStyle(fontSize: 14)),
            ],
          ),
        );
      },
